...
$lang['openfire_change_xmpp_help'] = 'Changing the XMPP Domain after initialization should be done with extreme caution.  Click on the button below to allow changes.';
